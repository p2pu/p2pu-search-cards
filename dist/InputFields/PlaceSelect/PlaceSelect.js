...
const CustomOption = ({
  innerProps,
  isDisabled
}) => !isDisabled ? /*#__PURE__*/React.createElement("div", innerProps) : null;
...
export default class PlaceSelect extends Component {
  constructor(props) {
    ...
    _defineProperty(this, "searchPlaces", query => {
    ...
    _defineProperty(this, "fetchPlaceById", placeId => {
    ...
    _defineProperty(this, "generateCityOption", place => {
      return {
